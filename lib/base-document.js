...
export class BaseDocument {
    ...
    onUnknownData(dataKey, dataVal) {
        if (THROW_ON_UNKNOWN_DATA) {
            throw new Error(`Unknown key "${dataKey}" in data object for new ${this.constructor.name} instance`);
        }
    }
...
/**
 * This constant is kinda superfluous, but jsdoc would complain in overridden onUnknownData() methods 
 * if {@link BaseDocument.onUnknownData} threw Error without any condition. There's probably a better solution, but hey..
 */
const THROW_ON_UNKNOWN_DATA = true;
